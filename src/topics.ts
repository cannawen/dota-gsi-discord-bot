...
const gsi = {
    ...
    // building
    t1Top: new Topic<[number, number]>("t1Top"),
    t2Top: new Topic<[number, number]>("t2Top"),
    t3Top: new Topic<[number, number]>("t3Top"),
    t4Top: new Topic<[number, number]>("t4Top"),
    t1Mid: new Topic<[number, number]>("t1Mid"),
    t2Mid: new Topic<[number, number]>("t2Mid"),
    t3Mid: new Topic<[number, number]>("t3Mid"),
    t1Bot: new Topic<[number, number]>("t1Bot"),
    t2Bot: new Topic<[number, number]>("t2Bot"),
    t3Bot: new Topic<[number, number]>("t3Bot"),
    t4Bot: new Topic<[number, number]>("t4Bot"),
    ancient: new Topic<[number, number]>("ancient"),
