...
const gsi = {
    ...
    // map + minimap
    allFriendlyHeroes: new PersistentTopic<DeepReadonly<string[]>>(
        "allFriendlyHeroes",
        { defaultValue: [], persistAcrossRestarts: true }
    ),
    allEnemyHeroes: new PersistentTopic<DeepReadonly<string[]>>(
        "allEnemyHeroes",
        {
            defaultValue: [],
